...
const todo_model_1 = require("./db/models/todo.model");
...
app.get("/todos", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tasks = yield todo_model_1.Todo.findAll();
        res.json(tasks);
    }
    catch (error) {
...
app.get('/todos/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const todo = yield todo_model_1.Todo.findByPk(req.params.id);
        if (todo) {
            res.json(todo);
        }
        else {
...
app.post('/tarea', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { title, description } = req.body;
        const newTask = yield todo_model_1.Todo.create({
            title,
            description,
            completed: false
        });
...
app.delete('/borrar/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const todo = yield todo_model_1.Todo.findByPk(req.params.id);
        if (todo) {
            yield todo.destroy();
